...
INSERT INTO public.appointments VALUES (10, 8, 2, '11am');
...
INSERT INTO public.services VALUES (1, 'Nails cleaning');
...
SELECT pg_catalog.setval('public.appointments_appointments_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.customers_customers_id_seq', 18, true);
